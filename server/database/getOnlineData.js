...
// const getAllBillsBySession = async (sessionId) => {
//     const billsUrl = `/bills/${sessionId}/billlist/${devToken}`;
...
// const getAllPassedBillsBySession = async (sessionId) => {
//     const billsUrl = `/bills/${sessionId}/passedlist/${devToken}`;
//     const finalUrl = baseUrl + billsUrl;
...
// const getBill = async (sessionId, billId) => {
//     const billsUrl = `/bills/${sessionId}/${billId}/${devToken}`;
//     const finalUrl = baseUrl + billsUrl;
...
//     getAllBillsBySession,
//     getBill,
//     getAllPassedBillsBySession,
// };
